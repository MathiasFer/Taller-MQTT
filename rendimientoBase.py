...
topic_registro_rendimiento = "topico_a_enviar"
...
recipient_email = "mathiasfer4.1@gmail.com"

# Configuración de la conexión SQLite
sqlite_database = "rendimiento.db"
...
try:
    ...
    cursor.execute("""
        CREATE TABLE IF NOT EXISTS datos_pc (
            ...
            fecha_hora TEXT,
            mac_address TEXT,
            rendimiento_cpu REAL,
            rendimiento_memoria REAL,
...
def calcular_diferencia_y_enviar(mensaje):
    ...
    diferencia_registro = "Diferencia en registro:\n"
        ...
        if ':' in linea_equipo1 and ':' in linea_equipo2:
            ...
            if clave1 == clave2:
                try:
                    ...
                    diferencia_registro += f"{clave1}: {diferencia}\n"
                except ValueError:
                    print(f"Error al calcular la diferencia para {clave1}.")

    # Enviar la diferencia al tópico correspondiente
    client.publish(topic_registro_rendimiento, diferencia_registro)
